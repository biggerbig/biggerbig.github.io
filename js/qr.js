    ...
    var g = {
            ...
            decode: function (a) {
                ...
                d.onload = function () {
                    ...
                    var replaceText = qrTextData.replace("http://qr.nlotto.co.kr/?v=", "").replace("http://qr.645lotto.net/?v=", "").replace(/a|b|c|d|e|f|g|h|i|j|k|l|n|o|p|q|r|s|t|u|v|w|x|y|z/gi, "m"); 
                    var qs = replaceText
                    var round = 0;
                    var lotto_number = [];
                    ...
                    lot_numbers.map((num, idx) => {
                        if (idx === 0) {
                            round = num.substring(1) + "회차에 구매하신 번호"
                        } else {
                            var lot_num = [];
