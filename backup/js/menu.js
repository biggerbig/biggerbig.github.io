...
$(".open_lyrics").click(function () {
    $(".layer_pop_wrap,body,.page_wrap").addClass("open");
    window.location.hash = "#menu-open";
});

window.onhashchange = function () {
    if (location.hash != "#menu-open") {
        $(".menu_m,body,.page_wrap,.layer_pop_wrap").removeClass("open");
    }
};
...
$("#comment").focus(function () {
    if ($("#footer").hasClass("open")) {
        $(".comnt_input_wrap").addClass("focused");
        $(".comnt_input_wrap").addClass("bottom_60");
    } else {
        $(".comnt_input_wrap").addClass("focused");
        $(".comnt_input_wrap").addClass("bottom_0");
    }
});

$("#comment").blur(function () {
    $(".comnt_input_wrap").removeClass("focused");
    $(".comnt_input_wrap").removeClass("bottom_60");
    $(".comnt_input_wrap").removeClass("bottom_0");
});
