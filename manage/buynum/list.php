...
<div class="dash_con_wrap">
    <div class="mydash">
        <h4>내 로또
            <span>회차별 구매한 로또</span>
        </h4>
        <div class="dash_con_inner">
            <div class="buynumber">
                <ul>
                    <li>
                        <a href="/manage/buynum/buynum.php" class="buynumber_inner">
                            <h5>815회</h5>
                            <p>2018.09.15</p>
                            <span><em>5</em>게임</span>
                        </a>
                    </li>
                    <li>
                        <a href="/manage/buynum/buynum.php" class="buynumber_inner">
                    ...
                    <!-- <li>
                        <div class="add_num_item add_trigger"></div>
                    </li> -->
                </ul>
            </div>
        </div>
...
<script>
    $('#code_result').val('new_value').trigger('change');
    $("#code_result").change(function () {
        var qrResultURL = $('#code_result').val();
        alert("qrResultURL");
    });
    $('#code_result').on('input', function () {
